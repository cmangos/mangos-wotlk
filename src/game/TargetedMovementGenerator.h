...
{
    template<class T, class ChaseMovementGenerator<class T> > friend class TargetedMovementGeneratorMedium;
...
{
    template<class T, class FollowMovementGenerator<class T> > friend class TargetedMovementGeneratorMedium;
