...
class MANGOS_DLL_SPEC PlayerbotWarlockAI : PlayerbotClassAI
{
    ...
    private:
        ...
        // CURSES
        uint32 CURSE_OF_WEAKNESS, CURSE_OF_AGONY, CURSE_OF_EXHAUSTION, CURSE_OF_TONGUES, CURSE_OF_THE_ELEMENTS;

        // AFFLICTION
        uint32 CORRUPTION, DRAIN_SOUL, DRAIN_LIFE, DRAIN_MANA, LIFE_TAP, UNSTABLE_AFFLICTION, HAUNT, ATROCITY, SEED_OF_CORRUPTION, DARK_PACT, HOWL_OF_TERROR;
        ...
        // DEMONOLOGY
        uint32 DEMON_SKIN, DEMON_ARMOR, SHADOW_WARD, FEL_ARMOR, SOULSHATTER, SOUL_LINK, HEALTH_FUNNEL;
