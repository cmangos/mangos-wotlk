...
class MANGOS_DLL_SPEC PlayerbotWarlockAI : PlayerbotClassAI
{
    ...
    private:
        ...
        // DEMONOLOGY
        uint32 DEMON_SKIN, DEMON_ARMOR, SHADOW_WARD, FEL_ARMOR, SOULSHATTER, SUMMON_IMP, SUMMON_VOIDWALKER, SUMMON_SUCCUBUS, SUMMON_FELHUNTER, SUMMON_FELGUARD, SOUL_LINK, HEALTH_FUNNEL;
