...
class MANGOS_DLL_SPEC PlayerbotPaladinAI : PlayerbotClassAI
{
    ...
    private:
        ...
        // Holy
        uint32 FLASH_OF_LIGHT, HOLY_LIGHT, DIVINE_SHIELD, HAMMER_OF_WRATH, CONSECRATION, CONCENTRATION_AURA, DIVINE_FAVOR, SACRED_SHIELD, HOLY_SHOCK, HOLY_WRATH, LAY_ON_HANDS, EXORCISM;
