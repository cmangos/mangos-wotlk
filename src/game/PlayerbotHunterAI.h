...
class MANGOS_DLL_SPEC PlayerbotHunterAI : PlayerbotClassAI
{
    ...
    private:
        ...
        uint32 PET_SUMMON, PET_DISMISS, PET_REVIVE, PET_MEND, BAD_ATTITUDE, SONIC_BLAST, NETHER_SHOCK, DEMORALIZING_SCREECH, INTIMIDATION;
        ...
        uint32 RAPTOR_STRIKE, WING_CLIP, MONGOOSE_BITE, DISENGAGE;
        uint32 BEAR_TRAP, FREEZING_TRAP, IMMOLATION_TRAP, FROST_TRAP, EXPLOSIVE_TRAP, ARCANE_TRAP;
        uint32 ASPECT_OF_THE_HAWK, ASPECT_OF_THE_MONKEY, RAPID_FIRE, TRUESHOT_AURA;
};
