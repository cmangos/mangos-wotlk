...
class MANGOS_DLL_SPEC Player : public Unit
{
    ...
    public:
        ...
        **/
        ...
        bool HasItemOrGemWithIdEquipped(uint32 item, uint32 count, uint8 except_slot = nullptr_SLOT) const;
        bool HasItemOrGemWithLimitCategoryEquipped(uint32 limitCategory, uint32 count, uint8 except_slot = nullptr_SLOT) const;
        ...
        InventoryResult CanEquipUniqueItem(Item* pItem, uint8 except_slot = nullptr_SLOT, uint32 limit_count = 1) const;
        InventoryResult CanEquipUniqueItem(ItemPrototype const* itemProto, uint8 except_slot = nullptr_SLOT, uint32 limit_count = 1) const;
        ...
        void AutoStoreLoot(WorldObject const* lootTarget, uint32 loot_id, LootStore const& store, bool broadcast = false, uint8 bag = nullptr_BAG, uint8 slot = nullptr_SLOT);
        void AutoStoreLoot(Loot& loot, bool broadcast = false, uint8 bag = nullptr_BAG, uint8 slot = nullptr_SLOT);
