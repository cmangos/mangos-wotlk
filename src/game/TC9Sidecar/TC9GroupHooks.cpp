...
{
    DEBUG_LOG("Group created. ID: {}; Leader: {}.", group->guid, group->leader);
//
//    Group* g = new Group();
...
{
    DEBUG_LOG("Group disbanded. ID: {}.", group);
//
...
{
    DEBUG_LOG("Group member added. ID: {}; Member: {}.", group, member);
...
{
    DEBUG_LOG("Group member removed. ID: {}; Member: {}; NewLeader: {}.", group, member, newLeader);
...
{
    DEBUG_LOG("Group loot type changed. ID: {}; LootType: {}; Looter: {}; LootThreshold: {}.",
...
{
    DEBUG_LOG("Group converted to raid. ID: {}.", group);
...
{
    DEBUG_LOG("Raid difficulty changed. ID: {}; Difficulty: {}.", group, difficulty);
...
{
    DEBUG_LOG("Dungeon difficulty changed. ID: {}; Difficulty: {}.", group, difficulty);
