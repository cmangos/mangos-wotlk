...
{
    _clusterModeEnabled = sConfig.GetBoolDefault("Cluster.Enabled", false);
    ...
    if (_clusterModeEnabled)
    {
        ...
        std::string availableMaps = sConfig.GetStringDefault("Cluster.AvailableMaps", AVAILABLE_MAPS_ALL_MAPS);
