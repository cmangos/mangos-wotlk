...
class MANGOS_DLL_SPEC PlayerbotWarriorAI : PlayerbotClassAI
{
    ...
    private:
        ...
        // PROTECTION
        uint32 BLOODRAGE, DEFENSIVE_STANCE, SUNDER_ARMOR, TAUNT, SHIELD_BASH, REVENGE, SHIELD_BLOCK, DISARM, SHIELD_WALL, SHIELD_SLAM, VIGILANCE, DEVASTATE, SHOCKWAVE, CONCUSSION_BLOW, SPELL_REFLECTION;

        // FURY
        uint32 BATTLE_SHOUT, DEMORALIZING_SHOUT, CLEAVE, INTIMIDATING_SHOUT, EXECUTE, CHALLENGING_SHOUT, SLAM, BERSERKER_STANCE, INTERCEPT, DEATH_WISH, BERSERKER_RAGE, WHIRLWIND, PUMMEL, BLOODTHIRST, RECKLESSNESS, RAMPAGE, HEROIC_FURY, COMMANDING_SHOUT, ENRAGED_REGENERATION;
