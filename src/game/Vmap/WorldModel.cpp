...
namespace VMAP
{
    ...
    bool GroupModel::IntersectRay(G3D::Ray const& ray, float& distance, bool stopAtFirstHit, bool checkLOS) const
    {
        if (triangles.empty())
            return false;
    ...
    bool WorldModel::IntersectRay(G3D::Ray const& ray, float& distance, bool stopAtFirstHit, bool checkLOS) const
    {
