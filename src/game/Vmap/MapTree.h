...
namespace VMAP
{
    ...
    class StaticMapTree
    {
        ...
        private:
            bool getIntersectionTime(G3D::Ray const& pRay, float& pMaxDist, bool pStopAtFirstHit = false, bool pCheckLOS = false) const;
        ...
        public:
            ...
            static bool CanLoadMap(std::string const& basePath, uint32 mapID, uint32 tileX, uint32 tileY);
