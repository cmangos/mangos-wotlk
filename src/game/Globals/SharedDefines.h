...
enum CreatureTypeFlags
{
    ...
    CREATURE_TYPEFLAGS_FORCE_GOSSIP     = 0x08000000,       // used in Lua_ForceGossip, tells the client to not select gossip option automatically in case there's only one available
