...
enum CreatureTypeFlags
{
    ...
    INTERACT_DEAD         = 0x00000080,       // Creature can be interacted with even if it's dead
    HERBLOOT              = 0x00000100,       // Can be looted by herbalist
    MININGLOOT            = 0x00000200,       // Can be looted by miner
    NO_DEATH_MSG          = 0x00000400,       // no idea, but it used by client
    MOUNTED_COMBAT        = 0x00000800,       // possibility to attack and cast spells while mounted
    ...
    MODEL_COLLISION_SIZE  = 0x00020000,     // related to CreatureDisplayInfo and scaling in some way
    SIEGE_WEAPON          = 0x00040000,       // Related to vehicle/siege weapons
    COLLIDE_WITH_MISSILES = 0x00080000,    // may be has something to do with missiles
    NO_NAMEPLATE          = 0x00100000,       // no idea, but it used by client, may be related to rendering
    NO_MOUNTED_ANIM       = 0x00200000,       // may be has something to do with animation (disable animation?)
    ...
    NO_DEATH_SOUND        = 0x01000000,       // pet sounds related?
    NO_SHADOW_BLOB        = 0x02000000,       // this one probably controls some creature visual
    TREAT_AS_IN_RAID      = 0x04000000,       // creature has no type, or forces creature to be considered as in party, may be related to creature assistance
    FORCE_GOSSIP          = 0x08000000,       // used in Lua_ForceGossip
    DO_NOT_SHEATHE        = 0x10000000,       // no idea, but it used by client
    NO_INTERACT_TARGET    = 0x20000000,
    DO_NOT_RENDER_NAME    = 0x40000000,
