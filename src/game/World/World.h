...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_WORLD_AUTOSCALE_PLAYERS_THRESHOLD,
    CONFIG_UINT32_WORLD_AUTOSCALE_MIN_PLAYER_LEVEL,
    CONFIG_UINT32_WORLD_AUTOSCALE_DOWNSCALE_DELAY,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_WORLD_AUTOSCALE_DISTANCE_MAX,
    CONFIG_FLOAT_WORLD_AUTOSCALE_DISTANCE_COMBAT,
    CONFIG_FLOAT_WORLD_AUTOSCALE_RATE_HEALTH,
    CONFIG_FLOAT_WORLD_AUTOSCALE_RATE_DAMAGE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_INSTANCE_AUTOSCALE,
    CONFIG_BOOL_XP_AUTOSCALE,
    CONFIG_BOOL_WORLD_AUTOSCALE,
