...
pAuraHandler AuraHandler[TOTAL_AURAS] =
{
    ...
    &Aura::Handlenullptr,                                      //177 SPELL_AURA_AOE_CHARM (22 spells)
    ...
    &Aura::Handlenullptr,                                      //196 SPELL_AURA_MOD_COOLDOWN (single spell 24818 in 3.2.2a)
    ...
    &Aura::Handlenullptr,                                      //221 ignored
    &Aura::HandleUnused,                                    //222 unused (3.0.8a-3.2.2a) only for spell 44586 that not used in real spell cast
    &Aura::Handlenullptr,                                      //223 dummy code (cast damage spell to attacker) and another dymmy (jump to another nearby raid member)
    ...
    &Aura::Handlenullptr,                                      //233 set model id to the one of the creature with id m_modifier.m_miscvalue
    ...
    &Aura::Handlenullptr,                                      //251 SPELL_AURA_MOD_ENEMY_DODGE
    ...
    &Aura::Handlenullptr,                                      //257 SPELL_AURA_MOD_TARGET_RESIST_BY_SPELL_CLASS Use SpellClassMask for spell select
    &Aura::Handlenullptr,                                      //258 SPELL_AURA_MOD_SPELL_VISUAL
    ...
    &Aura::Handlenullptr,                                      //297 1 spell (counter spell school?)
    ...
    &Aura::Handlenullptr,                                      //301 SPELL_AURA_HEAL_ABSORB 5 spells
    &Aura::HandleUnused,                                    //302 unused (3.2.2a)
    &Aura::Handlenullptr,                                      //303 17 spells
    ...
    &Aura::Handlenullptr,                                      //306 1 spell
    &Aura::Handlenullptr,                                      //307 absorb healing?
    &Aura::Handlenullptr,                                      //308 new aura for hunter traps
    &Aura::Handlenullptr,                                      //309 absorb healing?
    &Aura::HandleNoImmediateEffect,                         //310 SPELL_AURA_MOD_PET_AOE_DAMAGE_AVOIDANCE implemented in Unit::SpellDamageBonusTaken
    &Aura::Handlenullptr,                                      //311 0 spells in 3.3
    &Aura::Handlenullptr,                                      //312 0 spells in 3.3
    &Aura::Handlenullptr,                                      //313 0 spells in 3.3
    &Aura::HandlePreventResurrection,                       //314 SPELL_AURA_PREVENT_RESURRECTION
    &Aura::Handlenullptr,                                      //315 underwater walking
    &Aura::Handlenullptr                                       //316 makes haste affect HOT/DOT ticks
};
