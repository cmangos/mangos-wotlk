...
class MANGOS_DLL_SPEC PlayerbotMageAI : PlayerbotClassAI
{
    ...
    private:
        ...
        // buffs
        uint32 FROST_ARMOR, ICE_ARMOR, MAGE_ARMOR, ARCANE_INTELLECT, ARCANE_BRILLIANCE, DALARAN_INTELLECT, DALARAN_BRILLIANCE, MANA_SHIELD, DAMPEN_MAGIC, AMPLIFY_MAGIC;
