    ...
    : public MovementGeneratorMedium< T, PointMovementGenerator<T> >
{
    public:
        ...
        static MovementGeneratorType GetMovementGeneratorTypeStatic() { return POINT_MOTION_TYPE; }
    ...
    : public PointMovementGenerator<Creature>
{
    public:
        ...
        static MovementGeneratorType GetMovementGeneratorTypeStatic() { return ASSISTANCE_MOTION_TYPE; }
