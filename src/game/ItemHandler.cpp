...
void WorldSession::HandleBuyItemOpcode(WorldPacket& recv_data)
{
    ...
    GetPlayer()->BuyItemFromVendorSlot(vendorGuid, slot, item, count, nullptr_BAG, nullptr_SLOT);
}
...
void WorldSession::HandleSocketOpcode(WorldPacket& recv_data)
{
    ...
    uint8 slot = itemTarget->IsEquipped() ? itemTarget->GetSlot() : uint8(nullptr_SLOT);
