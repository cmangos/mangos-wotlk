...
pEffect SpellEffects[TOTAL_SPELL_EFFECTS] =
{
    ...
    &Spell::Effectnullptr,                                     // 46 SPELL_EFFECT_SPAWN                    spawn/login animation, expected by spawn unit cast, also base points store some dynflags
    ...
    &Spell::Effectnullptr,                                     // 73 SPELL_EFFECT_UNTRAIN_TALENTS          one spell: Trainer: Untrain Talents
    ...
    &Spell::Effectnullptr,                                     // 82 SPELL_EFFECT_BIND_SIGHT
    ...
    &Spell::Effectnullptr,                                     //135 SPELL_EFFECT_CALL_PET
    ...
    &Spell::Effectnullptr,                                     //148 SPELL_EFFECT_148                      single spell: Inflicts Fire damage to an enemy.
    &Spell::EffectCharge2,                                  //149 SPELL_EFFECT_CHARGE2                  swoop
    &Spell::EffectQuestOffer,                               //150 SPELL_EFFECT_QUEST_OFFER
    &Spell::EffectTriggerRitualOfSummoning,                 //151 SPELL_EFFECT_TRIGGER_SPELL_2
    &Spell::Effectnullptr,                                     //152 SPELL_EFFECT_152                      summon Refer-a-Friend
    ...
    &Spell::Effectnullptr,                                     //160 SPELL_EFFECT_160                      single spell: Nerub'ar Web Random Unit
...
void Spell::Effectnullptr(SpellEffectIndex /*eff_idx*/)
{
...
void Spell::DoCreateItem(SpellEffectIndex eff_idx, uint32 itemtype)
{
    ...
    uint32 no_space = 0;
    InventoryResult msg = player->CanStoreNewItem(nullptr_BAG, nullptr_SLOT, dest, newitemid, num_to_add, &no_space);
    if (msg != EQUIP_ERR_OK)
    {
