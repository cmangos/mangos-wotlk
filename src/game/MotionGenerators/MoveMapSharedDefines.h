...
static TileBuildings BuildingMap =
{
    ...
    TileBuilding(std::string("Icecrownraid_Arthas_Precipice_Phase0.wmo.vmo"), 503.619781494140625, -2124.654541015625, 836.60699462890625, 3.141592741012573242, 0, 0, -1, 0, 9276, false, true, 0, 202161),
