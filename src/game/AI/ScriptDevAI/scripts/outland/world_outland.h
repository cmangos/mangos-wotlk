...
enum
{
    ...
    QUEST_RING_OF_BLOOD_BROKENTOE = 9962,
    QUEST_RING_OF_BLOOD_MURKBLOOD_TWIN = 9967,
    QUEST_RING_OF_BLOOD_ROKDAR = 9970,
    QUEST_RING_OF_BLOOD_SKRAGATH = 9972,
    QUEST_RING_OF_BLOOD_WARMAUL_CHAMPION = 9973,
    QUEST_RING_OF_BLOOD_MOGOR = 9977,
