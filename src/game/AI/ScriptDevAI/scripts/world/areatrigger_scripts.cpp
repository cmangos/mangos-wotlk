...
bool AreaTrigger_at_quetzlun(Player* pPlayer, AreaTriggerEntry const* /*pAt*/)
{
    if (pPlayer->GetQuestStatus(QUEST_I_SENSE_A_DISTURBANCE) == QUEST_STATUS_INCOMPLETE)
        pPlayer->RewardPlayerAndGroupAtEventExplored(QUEST_I_SENSE_A_DISTURBANCE, pPlayer);
    return true;
}
