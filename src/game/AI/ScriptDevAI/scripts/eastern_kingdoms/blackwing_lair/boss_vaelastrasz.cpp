...
struct boss_vaelastraszAI : public ScriptedAI
{
    ...
    void UpdateAI(const uint32 uiDiff) override
    {
        ...
        if (m_uiBurningAdrenalineCasterTimer < uiDiff)
        {
            ...
            {
                pTarget->CastSpell(pTarget, SPELL_BURNING_ADRENALINE, TRIGGERED_OLD_TRIGGERED, NULL, NULL, m_creature->GetObjectGuid());
                m_uiBurningAdrenalineCasterTimer = 15000;
            }
        }
        else
        ...
        if (m_uiBurningAdrenalineTankTimer < uiDiff)
        {
            ...
            m_creature->getVictim()->CastSpell(m_creature->getVictim(), SPELL_BURNING_ADRENALINE, TRIGGERED_OLD_TRIGGERED, NULL, NULL, m_creature->GetObjectGuid());
