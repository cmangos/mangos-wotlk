                ...
                switch (action.type)
                {
                    ...
                    case ACTION_T_TEXT:
                    {
                        ...
                        for (int k = firstTextParam; k < 3; ++k)
                        {
                            if (action.text.TextId[k])
                            {
                                ...
                                {
                                    sLog.outErrorEventAI("Event %u Action %u param%d references out-of-range entry (%i) in texts table.", eventId, j + 1, k + 1, action.text.TextId[k]);
                    ...
                    case ACTION_T_TEXT_NEW:
                        if (action.textNew.textId)
                        {
                            ...
                            {
                                sLog.outErrorEventAI("Event %u Action %u references non-existing entry (%i) in texts table.", eventId, j + 1, action.textNew.textId);
