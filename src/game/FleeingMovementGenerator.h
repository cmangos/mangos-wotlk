    ...
    : public MovementGeneratorMedium< T, FleeingMovementGenerator<T> >
{
    public:
        ...
        static MovementGeneratorType GetMovementGeneratorTypeStatic() { return FLEEING_MOTION_TYPE; }
    ...
    : public FleeingMovementGenerator<Creature>
{
    public:
        ...
        static MovementGeneratorType GetMovementGeneratorTypeStatic() { return TIMED_FLEEING_MOTION_TYPE; }
