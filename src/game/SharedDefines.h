...
#define MAPID_CONTINENT_EASTERN 0
#define MAPID_CONTINENT_KALIMDOR 1
#define MAPID_CONTINENT_OUTLANDS 530
#define MAPID_CONTINENT_NORTHEND 571

#define MAP_IS_CONTINENT(m) ( (m) == MAPID_CONTINENT_EASTERN || (m) == MAPID_CONTINENT_KALIMDOR || (m) == MAPID_CONTINENT_OUTLANDS || (m) == MAPID_CONTINENT_NORTHEND )
#define MAP_LIST_CONTINENTS  MAPID_CONTINENT_EASTERN, MAPID_CONTINENT_KALIMDOR, MAPID_CONTINENT_OUTLANDS, MAPID_CONTINENT_NORTHEND
#define MAP_LIST_WORLD_MAPS MAP_LIST_CONTINENTS, 609
